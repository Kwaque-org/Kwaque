...
SEASTAR_TEST_CASE(event_log_matches_complete_golden_bytes_and_digest) {
    ...
    static constexpr std::array<std::uint8_t, 438> expected_bytes{
      ,
    ...
    BOOST_REQUIRE(
      source.append(stamp(*sequence, make_file_request())).has_value());
    BOOST_REQUIRE(
      source.append(stamp(*sequence, make_large_fault_request())).has_value());

    const auto encoded = source.encode();
    BOOST_REQUIRE(encoded.has_value());
    BOOST_REQUIRE_EQUAL(encoded->size(), expected_bytes.size());
    ...
    const auto& file_event = (*decoded)->entries()[0];
    BOOST_CHECK(file_event.kind() == event_kind::file_completion);
    BOOST_CHECK(file_event.severity() == event_severity::info);
    BOOST_CHECK_EQUAL(file_event.sequence(), 1U);
    BOOST_CHECK_EQUAL(file_event.shard().value(), 0U);
    BOOST_CHECK_EQUAL(
      file_event.monotonic().nanoseconds(), UINT64_C(0x1112131415161718));
    BOOST_CHECK_EQUAL(file_event.wall().unix_nanoseconds(), -4);
    BOOST_CHECK(
      file_event.workload() == kwaque::resource::workload_class::metadata);
    BOOST_REQUIRE_EQUAL(file_event.fields().size(), 4U);
    BOOST_CHECK(file_event.fields()[0].value.as_text() == "completed");
    BOOST_CHECK(file_event.fields()[1].value.as_text() == "file_write");
    BOOST_CHECK(
      file_event.fields()[2].value.as_unsigned()
      == UINT64_C(0x0102030405060708));
    BOOST_REQUIRE(file_event.fields()[3].value.as_stable_id().has_value());
    BOOST_CHECK_EQUAL(
      file_event.fields()[3].value.as_stable_id()->value(), 17U);

    const auto& fault_event = (*decoded)->entries()[1];
    BOOST_CHECK(fault_event.kind() == event_kind::fault_decision);
    BOOST_CHECK(fault_event.severity() == event_severity::warning);
    BOOST_CHECK_EQUAL(fault_event.sequence(), 2U);
    BOOST_CHECK_EQUAL(fault_event.shard().value(), 0U);
    BOOST_CHECK_EQUAL(
      fault_event.monotonic().nanoseconds(),
      std::numeric_limits<std::uint64_t>::max());
    BOOST_CHECK_EQUAL(
      fault_event.wall().unix_nanoseconds(),
      std::numeric_limits<std::int64_t>::min());
    BOOST_CHECK(
      fault_event.workload() == kwaque::resource::workload_class::maintenance);
    BOOST_REQUIRE_EQUAL(fault_event.fields().size(), 8U);
    BOOST_CHECK(fault_event.fields()[0].value.as_text() == "applied");
    BOOST_CHECK(fault_event.fields()[1].value.as_text() == "fault_evaluate");
    BOOST_CHECK(fault_event.fields()[2].value.as_text() == "fault_injected");
    BOOST_CHECK(
      fault_event.fields()[3].value.as_unsigned()
      == std::numeric_limits<std::uint64_t>::max());
    BOOST_REQUIRE(fault_event.fields()[4].value.as_stable_id().has_value());
    BOOST_CHECK_EQUAL(
      fault_event.fields()[4].value.as_stable_id()->value(),
      std::numeric_limits<std::uint64_t>::max());
    BOOST_CHECK(
      fault_event.fields()[5].value.as_unsigned()
      == std::numeric_limits<std::uint64_t>::max());
    BOOST_CHECK(
      fault_event.fields()[6].value.as_signed()
      == std::numeric_limits<std::int64_t>::min());
    BOOST_CHECK(fault_event.fields()[7].value.as_boolean() == true);
    co_return;
}
